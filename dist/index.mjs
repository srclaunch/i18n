...
function getLocale() {
  ...
  if (!locale) {
    ...
    if (!locale && ["LANG", "LANGUAGE"].some(Object.hasOwnProperty, process.env)) {
      return (({}).LANG || ({}).LANGUAGE || String()).replace(/[.:].*/, "").replace("_", "-");
    }
  }
  return locale;
}
...
export { addDecimalToNumber, formatCurrency, formatLocale, getDigitsFromValue, getFormattedLocale, getLocale, padDigits, removeLeadingZeros, toCurrency };
